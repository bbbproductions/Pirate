...
namespace Pirate.Content.Projectiles
{
	...
	public class TestMinionBuff : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[ModContent.ProjectileType<TestMinionProjectile>()] > 0) {
	...
	public class TestMinionItem : ModItem
	{
		public override void SetStaticDefaults() {
		...
		public override void SetDefaults() {
			...
			Item.shoot = ModContent.ProjectileType<TestMinionProjectile>(); // This item creates the minion projectile
		}
	...
	public class TestMinionProjectile : ModProjectile
	{
		public override void SetStaticDefaults() {
